...
export const MOVEMENT_PHRASES = {
  ...
  movementSedentaryTonusLow: [
    ...
    (ctx: MovementContext) => `Тонус на нуле и движение почти не зафиксировано (${ctx.activeMinutes} мин). Не обязательно идти в зал — даже короткая ходьба запустит кровоток и вернёт бодрость.`
  ],
